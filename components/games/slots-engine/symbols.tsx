...
export const BirdIcon: React.FC<SymbolIconProps> = ({ size = 32, className }) => (
  ...
  >
    ...
    <path d="M22 30Q10 18 8 26Q10 28 18 34Q14 22 22 30Z" fill="#db2777" />
    <path d="M16 38Q8 34 6 40Q10 40 16 42Z" fill="#be185d" />
    <path d="M16 40Q6 38 6 44Q10 43 16 44Z" fill="#db2777" />
    <path d="M42 18Q40 10 44 12Q46 14 44 18Z" fill="#f472b6" />
  </svg>
);
...
export const PotionIcon: React.FC<SymbolIconProps> = ({ size = 32, className }) => (
  ...
  >
    ...
    <path
      ...
      fill="#22c55e"
    />
    <path d="M22 24L18 34Q20 30 24 28Z" fill="white" opacity="0.2" />
...
export const LeafIcon: React.FC<SymbolIconProps> = ({ size = 32, className }) => (
  ...
  >
    <path
      ...
      fill="#16a34a"
    />
    <path d="M32 8Q54 14 56 36Q54 56 32 58V8Z" fill="#22c55e" opacity="0.4" />
    ...
    <path d="M32 54Q28 58 24 58" stroke="#15803d" strokeWidth="2" fill="none" strokeLinecap="round" />
  </svg>
);
