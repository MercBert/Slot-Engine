...
export function WinDisplay({
  ...
  /* --- count-up ----------------------------------------------------- */
  const animatedAmount = useCountUp(displayAmount, showWin);
          ...
          >
            ...
            {isBigWin && (
              <motion.div
                ...
                className="text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-300 drop-shadow-lg"
              >
                🎉 BIG WIN! 🎉
              </motion.div>
            )}
